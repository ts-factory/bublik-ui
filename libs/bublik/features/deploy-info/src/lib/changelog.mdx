...
* **measurements:** add missing measurement  ([436754c](https://github.com/ts-factory/bublik-ui/commit/436754c8b03eaeaa8a9887bc921d2471f957d933))
...
* **report:** [table] display  label in first column when have single series ([4336d22](https://github.com/ts-factory/bublik-ui/commit/4336d22d38b72327f00bfed3f41e3b17f16f926f))

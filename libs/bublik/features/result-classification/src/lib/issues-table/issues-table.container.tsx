...
import { STATUS_STRIPE_COLUMN_META, StatusStripe } from '../classification/status-stripe.component';
import {
	BugKeyChip,
	CategoryBadgeList,
	IssueRulesBadge,
...
import { ISSUE_ACTIONS_COLUMN_META, IssueStateActions } from '../issue-detail/issue-actions.container';

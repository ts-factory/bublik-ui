...
function RunHeaderCell({
	...
	return (
		...
		>
			{dragHandle ? (
				<>
					<div className="absolute right-0 top-0 z-10 flex h-full items-center opacity-0 transition-opacity group-hover/header:opacity-100 focus-within:opacity-100">
...
const dragHandleClassName =
	'grid h-5 w-4 shrink-0 cursor-grab touch-none place-items-center rounded text-text-menu hover:bg-primary-wash active:cursor-grabbing';

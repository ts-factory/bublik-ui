...
## [2.0.0](https://github.com/ts-factory/bublik-ui/compare/v1.10.3...v2.0.0) (2025-08-06)
...
* **import:** improve import log error handling and display ([7a91912](https://github.com/ts-factory/bublik-ui/commit/7a919122a04526bc900e64406c5773c147f8ae3d))
...
* **projects:** adapt to API change for `project_name` to `name` field ([33cf8ba](https://github.com/ts-factory/bublik-ui/commit/33cf8bac381f028af3f08f8aa4efd4ccd2109fe5))

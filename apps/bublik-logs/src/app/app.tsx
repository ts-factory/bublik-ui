...
import { SessionRoot } from '@/bublik/features/session-log';
...
function LogContainer() {
	...
	const id = searchParams.get('focusId')
		? Number(searchParams.get('focusId'))
		: undefined;
	...
	const { data, isLoading, error } = jsonAPI.useGetJsonLogQuery({
		id,
		page
	});

	if (isLoading) return <LogFrameLoading />;

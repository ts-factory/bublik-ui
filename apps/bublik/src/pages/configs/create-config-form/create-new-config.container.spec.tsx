...
describe('CreateNewConfigScreen project selection', () => {
	it('hides the project picker and clears a stale project for an AI config', async () => {
		...
		// The backend pins the ai config to No Project, so there is nothing to pick.
	...
	it('removes the project picker when a global config is renamed to ai', async () => {
